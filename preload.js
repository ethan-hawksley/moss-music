...
contextBridge.exposeInMainWorld("ytdlp", {
  downloadPlaylist: (playlistURL) =>
    ipcRenderer.invoke("downloadPlaylist", playlistURL),
  removePlaylist: (playlistID) =>
    ipcRenderer.invoke("removePlaylist", playlistID),
  onPlaylistProgress: (callback) =>
    ipcRenderer.on("playlistProgress", (_event, progress) =>
      callback(progress),
    ),
  ...
  swapPlaylists: (playlistID1, playlistID2) =>
    ipcRenderer.invoke("swapPlaylists", playlistID1, playlistID2),
});
